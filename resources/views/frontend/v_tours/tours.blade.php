    ...
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="{{ route('frontend.tours') }}" class="active">Tours</a></li>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8 mx-auto text-center mb-5">
            ...
            <p class="hero-description">Curated travel experiences that transform journeys into unforgettable stories. Filter by your preferences and find the perfect escape.</p>
          </div>
        </div>
          ...
          <div class="col-lg-10">
            <div class="search-container">
              ...
              <div class="filter-pills">
                ...
                <button class="filter-pill" data-filter="adventure">Adventure</button>
                <button class="filter-pill" data-filter="luxury">Luxury</button>
                <button class="filter-pill" data-filter="cultural">Cultural</button>
          ...
          <div class="col-12">
            <div class="featured-hero-tour">
              <div class="featured-image">
                <img src="{{ asset('frontend/img/travel/showcase-8.webp') }}" alt="Featured Destination" class="img-fluid">
              </div>
              <div class="featured-content">
                ...
                <div class="featured-meta">
                  ...
                  <span class="group-size">Max 8 People</span>
                  <span class="rating">
                ...
                <div class="featured-actions">
                  <a href="#" class="btn btn-primary">Explore This Journey</a>
                  <a href="#" class="btn btn-text">View Itinerary</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="categories-grid">
              <div class="category-item">
                <div class="category-visual">
                  <img src="{{ asset('frontend/img/travel/misc-3.webp') }}" alt="Mountain Adventures" class="img-fluid">
                </div>
                <h5>Mountain Adventures</h5>
                <span class="tour-count">24 tours</span>
              </div>
              <div class="category-item">
                <div class="category-visual">
                  <img src="{{ asset('frontend/img/travel/misc-7.webp') }}" alt="Cultural Heritage" class="img-fluid">
                </div>
                <h5>Cultural Heritage</h5>
                <span class="tour-count">18 tours</span>
              </div>
              <div class="category-item">
                <div class="category-visual">
                  <img src="{{ asset('frontend/img/travel/misc-11.webp') }}" alt="Coastal Escapes" class="img-fluid">
                </div>
              ...
              <div class="category-item">
                <div class="category-visual">
                  <img src="{{ asset('frontend/img/travel/misc-15.webp') }}" alt="Wildlife Safari" class="img-fluid">
                </div>
                <h5>Wildlife Safari</h5>
                <span class="tour-count">16 tours</span>
              </div>
              <div class="category-item">
                <div class="category-visual">
                  <img src="{{ asset('frontend/img/travel/misc-2.webp') }}" alt="Urban Explorer" class="img-fluid">
                </div>
                <h5>Urban Explorer</h5>
                <span class="tour-count">28 tours</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="tours-grid">
              <div class="tour-item">
                <div class="tour-image">
                  <img src="{{ asset('frontend/img/travel/tour-12.webp') }}" alt="Norwegian Fjords" class="img-fluid">
                  <div class="tour-availability">5 dates available</div>
                </div>
                <div class="tour-details">
                  <h4>Norwegian Fjords Explorer</h4>
                  <p>Cruise through dramatic fjords and witness cascading waterfalls in one of nature's most spectacular theaters.</p>
              ...
              <div class="tour-item">
                <div class="tour-image">
                  <img src="{{ asset('frontend/img/travel/tour-4.webp') }}" alt="Moroccan Odyssey" class="img-fluid">
                ...
                <div class="tour-details">
                  ...
                  <div class="tour-highlights">
                    ...
                    <span><i class="bi bi-people"></i> Private Option</span>
              ...
              <div class="tour-item">
                <div class="tour-image">
                  <img src="{{ asset('frontend/img/travel/tour-21.webp') }}" alt="Patagonia Wilderness" class="img-fluid">
                  <div class="tour-availability">Next: Mar 15</div>
                </div>
                <div class="tour-details">
                  ...
                  <div class="tour-highlights">
                    ...
                    <span><i class="bi bi-people"></i> Adventure Level</span>
              ...
              <div class="tour-item">
                <div class="tour-image">
                  <img src="{{ asset('frontend/img/travel/tour-9.webp') }}" alt="Japanese Gardens" class="img-fluid">
                  <div class="tour-availability">Cherry blossom season</div>
                </div>
                <div class="tour-details">
                  ...
                  <div class="tour-highlights">
                    <span><i class="bi bi-clock"></i> 11 Days</span>
                    <span><i class="bi bi-people"></i> Cultural Focus</span>
                    <span><i class="bi bi-star-fill"></i> 4.8</span>
                  </div>
                  <div class="tour-pricing">
              ...
              <div class="tour-item">
                <div class="tour-image">
                  <img src="{{ asset('frontend/img/travel/tour-16.webp') }}" alt="Scottish Highlands" class="img-fluid">
                  <div class="tour-availability">Year-round</div>
                </div>
                <div class="tour-details">
                  ...
                  <div class="tour-highlights">
                    ...
                    <span><i class="bi bi-people"></i> History &amp; Nature</span>
              ...
              <div class="tour-item">
                <div class="tour-image">
                  <img src="{{ asset('frontend/img/travel/tour-28.webp') }}" alt="Costa Rica Wildlife" class="img-fluid">
                  <div class="tour-availability">Eco-certified</div>
                </div>
                <div class="tour-details">
                  ...
                  <div class="tour-highlights">
                    ...
                    <span><i class="bi bi-people"></i> Eco-Tourism</span>
                    <span><i class="bi bi-star-fill"></i> 4.7</span>
                  </div>
                  <div class="tour-pricing">
            ...
            <div class="offers-container">
              <div class="offer-card">
                <div class="offer-image">
                  <img src="{{ asset('frontend/img/travel/showcase-12.webp') }}" alt="Early Bird Special" class="img-fluid">
                </div>
              ...
              <div class="offer-card">
                <div class="offer-image">
                  <img src="{{ asset('frontend/img/travel/showcase-6.webp') }}" alt="Last Minute Deal" class="img-fluid">
                </div>
                <div class="offer-content">
