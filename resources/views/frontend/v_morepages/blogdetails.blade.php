...
<head>
  ...
  <title>Blog Details - TravelTime Bootstrap Template</title>
  <meta name="description" content="">
  <meta name="keywords" content="">

  <!-- Favicons -->
  <link href="{{ asset('frontend/img/favicon.png') }}" rel="icon">
  <link href="{{ asset('img/apple-touch-icon.eng') }}" rel="apple-touch-icon">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>More Pages</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="{{ asset('frontend/destination-details.html') }}">Destination Details</a></li>
              <li><a href="{{ asset('frontend/tour-details.html') }}">Tour Details</a></li>
              <li><a href="{{ asset('frontend/booking.html') }}">Booking</a></li>
              <li><a href="{{ asset('frontend/testimonials.html') }}">Testimonials</a></li>
              <li><a href="{{ asset('frontend/faq.html') }}">Frequently Asked Questions</a></li>
              <li><a href="{{ asset('frontend/blog-details.html') }}" class="active">Blog Details</a></li>
              <li><a href="{{ asset('frontend/terms.html') }}">Terms</a></li>
              <li><a href="{{ asset('frontend/privacy.html') }}">Privacy</a></li>
              <li><a href="{{ asset('frontend/404.html') }}">404</a></li>
            </ul>
          </li>
    ...
    <section id="blog-details" class="blog-details section">
      <div class="container">
        ...
        <article class="article">
          ...
          <div class="hero-img">
            <img src="{{ asset('frontend/img/blog/blog-post-3.webp') }}" alt="Featured blog image" class="img-fluid" loading="lazy">
          ...
          <div class="article-content">
            <div class="content-header">
              ...
              <div class="author-info">
                <div class="author-details">
                  <img src="{{ asset('frontend/img/person/person-f-8.webp" alt="Author" class="author-img">
                  <div class="info">
                    <h4>Michael Chen</h4>
            ...
            <div class="content">
              ...
              <div class="content-image right-aligned">
                <img src="{{ asset('frontend/img/blog/blog-hero-2.webp') }}" class="img-fluid" alt="Modern web development tools" loading="lazy">
        ...
        <div class="author-card">
          <div class="author-background">
            <div class="author-image-wrapper">
              <img src="{{ asset('frontend/img/person/person-m-12.webp') }}" class="author-image" alt="" loading="lazy">
            </div>
          </div>
          ...
          <div class="comments-container">
            ...
            <div class="comment-thread">
              <div class="comment-box">
                <div class="comment-wrapper">
                  <div class="avatar-wrapper">
                    <img src="{{ asset('frontend/img/person/person-f-9.webp') }}" alt="Avatar" loading="lazy">
              ...
              <div class="replies-container">
                ...
                <div class="comment-box reply">
                  <div class="comment-wrapper">
                    <div class="avatar-wrapper">
                      <img src="{{ asset('frontend/img/person/person-m-9.webp') }}" alt="Avatar" loading="lazy">
                      <span class="status-indicator"></span>
                    </div>
            ...
            <div class="comment-thread">
              <div class="comment-box">
                <div class="comment-wrapper">
                  <div class="avatar-wrapper">
                    <img src="{{ asset('frontend/img/person/person-f-7.webp') }}" alt="Avatar" loading="lazy">
                    <span class="status-indicator"></span>
                  </div>
