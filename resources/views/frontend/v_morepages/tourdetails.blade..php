        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>More Pages</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              ...
              <li><a href="tour-details.html" class="active">Tour Details</a></li>
      ...
      <div class="container">
        ...
        <div class="tour-hero">
          <div class="hero-image-wrapper">
            <img src="{{ asset('frontend/img/travel/showcase-7.webp') }}" alt="Mediterranean Coast Adventure" class="hero-image">
            <div class="hero-overlay">
              <div class="hero-content">
                <span class="tour-type">Cultural Explorer</span>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-4">
              <div class="pricing-card">
                ...
                <a href="#booking" class="btn-reserve">Reserve Your Journey</a>
          ...
          <div class="timeline-wrapper">
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-content">
                ...
                <div class="day-features">
                  <span class="feature-tag">Skip-the-line Tours</span>
                  <span class="feature-tag">Cooking Experience</span>
                </div>
              </div>
            </div>
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-content">
                ...
                <div class="day-features">
                  <span class="feature-tag">Palazzo Magnani Feroni</span>
                  <span class="feature-tag">Art Expert Guide</span>
                </div>
              </div>
            </div>
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-content">
                ...
                <div class="day-features">
                  <span class="feature-tag">Wine Tasting</span>
                  <span class="feature-tag">Gelato Making</span>
                </div>
              </div>
            </div>
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-content">
                <div class="day-header">
                  ...
                  <span class="location">Amalfi Coast</span>
                </div>
                ...
                <div class="day-features">
                  <span class="feature-tag">Casa Angelina</span>
                  <span class="feature-tag">Sunset Cruise</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="visual-gallery">
          ...
          <div class="gallery-grid">
            <div class="gallery-piece large">
              <a href="{{ asset('frontend/img/travel/destination-4.webp') }}" class="glightbox">
                <img src="{{ asset('frontend/img/travel/destination-4.webp') }}" alt="Italian Countryside" class="img-fluid" loading="lazy">
              </a>
            </div>
            <div class="gallery-piece">
              <a href="{{ asset('frontend/img/travel/destination-5.webp') }}" class="glightbox">
                <img src="{{ asset('frontend/img/travel/destination-5.webp') }}" alt="Historic Architecture" class="img-fluid" loading="lazy">
              </a>
            </div>
            <div class="gallery-piece">
              <a href="{{ asset('frontend/img/travel/destination-6.webp') }}" class="glightbox">
                <img src="{{ asset('frontend/img/travel/destination-6.webp') }}" alt="Coastal Views" class="img-fluid" loading="lazy">
              </a>
            </div>
            <div class="gallery-piece">
              <a href="{{ asset('frontend/img/travel/tour-8.webp') }}" class="glightbox">
                <img src="{{ asset('frontend/img/travel/tour-8.webp') }}" alt="Cultural Experience" class="img-fluid" loading="lazy">
              </a>
            </div>
            <div class="gallery-piece">
              <a href="{{ asset('frontend/img/travel/tour-9.webp') }}" class="glightbox">
                <img src="{{ asset('frontend/img/travel/tour-9.webp') }}" alt="Local Cuisine" class="img-fluid" loading="lazy">
              </a>
            </div>
            <div class="gallery-piece medium">
              <a href="{{ asset('frontend/img/travel/tour-10.webp') }}" class="glightbox">
                <img src="{{ asset('frontend/img/travel/tour-10.webp') }}" alt="Scenic Landscapes" class="img-fluid" loading="lazy">
              </a>
            </div>
          </div>
        </div>
