...
<head>
  ...
  <title>Destination Details - TravelTime Bootstrap Template</title>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;<|fim_suffix|>
  <!-- Vendor CSS Files -->
      ...
      <div class="container">
        ...
        <div class="destination-hero">
          <div class="hero-content">
            <h1 class="destination-name">Bali, Indonesia</h1>
            <p class="destination-tagline">Island of the Gods</p>
          </div>
          <div class="hero-image">
            <img src="{{ asset('frontend/assets/img/travel/showcase-3.webp') }}" alt="Bali destination" class="img-fluid">
          </div>
        </div>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-4">
              <div class="overview-image">
                <img src="{{ asset('frontend/assets/img/travel/destination-5.webp') }}" alt="Bali culture" class="img-fluid">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="destination-highlights">
          ...
          <div class="row gy-4">
            <div class="col-lg-4 col-md-6">
              <div class="highlight-item">
                <div class="highlight-image">
                  <img src="{{ asset('frontend/assets/img/travel/destination-8.webp') }}" alt="Temple complex" class="img-fluid">
                </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="highlight-item">
                <div class="highlight-image">
                  <img src="{{ asset('frontend/assets/img/travel/destination-12.webp') }}" alt="Rice terraces" class="img-fluid">
                </div>
                <div class="highlight-content">
                  <h4>Rice Terraces</h4>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="highlight-item">
                <div class="highlight-image">
                  <img src="{{ asset('frontend/assets/img/travel/destination-15.webp') }}" alt="Pristine beaches" class="img-fluid">
                </div>
                <div class="highlight-content">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="highlight-item">
                <div class="highlight-image">
                  <img src="{{ asset('frontend/assets/img/travel/destination-3.webp') }}" alt="Traditional markets" class="img-fluid">
                </div>
                <div class="highlight-content">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="highlight-item">
                <div class="highlight-image">
                  <img src="{{ asset('frontend/assets/img/travel/destination-7.webp') }}" alt="Volcano hiking" class="img-fluid">
                </div>
                <div class="highlight-content">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="highlight-item">
                <div class="highlight-image">
                  <img src="{{ asset('frontend/assets/img/travel/destination-11.webp') }}" alt="Cultural performances" class="img-fluid">
                </div>
                <div class="highlight-content">
        ...
        <div class="available-tours">
          ...
          <div class="row gy-4">
            <div class="col-lg-4 col-md-6">
              <div class="tour-card">
                <div class="tour-image">
                  <img src="{{ asset('frontend/assets/img/travel/tour-8.webp') }}" alt="Cultural Heritage Tour" class="img-fluid">
                ...
                <div class="tour-content">
                  ...
                  <div class="tour-meta">
                    <span class="tour-price">$589</span>
                    <span class="tour-rating">
                      <i class="bi bi-star-fill"></i>
                      <span>4.8</span>
                    </span>
                  </div>
                  <a href="#" class="btn-tour">View Details <i class="bi bi-arrow-right"></i></a>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="tour-card">
                <div class="tour-image">
                  <img src="{{ asset('frontend/assets/img/travel/tour-12.webp') }}" alt="Adventure Package" class="img-fluid">
                  <div class="tour-duration">
                    <span>7 Days</span>
                  </div>
                </div>
                <div class="tour-content">
                  ...
                  <div class="tour-meta">
                    <span class="tour-price">$759</span>
                    <span class="tour-rating">
                      <i class="bi bi-star-fill"></i>
                      <span>4.9</span>
                    </span>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="tour-card">
                <div class="tour-image">
                  <img src="{{ asset('frontend/assets/img/travel/tour-15.webp') }}" alt="Wellness Retreat" class="img-fluid">
                  <div class="tour-duration">
                    <span>4 Days</span>
                  </div>
                </div>
                <div class="tour-content">
                  ...
                  <div class="tour-meta">
                    <span class="tour-price">$445</span>
                    <span class="tour-rating">
                      <i class="bi bi-star-fill"></i>
                      <span>4.7</span>
                    </span>
        ...
        <div class="destination-gallery">
          ...
          <div class="gallery-grid">
            <div class="gallery-item large">
              <a href="{{ asset('frontend/assets/img/travel/showcase-5.webp') }}" class="glightbox">
                <img src="{{ asset('frontend/assets/img/travel/showcase-5.webp') }}" alt="Gallery image" class="img-fluid">
              </a>
            </div>

            <div class="gallery-item">
              <a href="{{ asset('frontend/assets/img/travel/destination-9.webp') }}" class="glightbox">
                <img src="{{ asset('frontend/assets/img/travel/destination-9.webp') }}" alt="Gallery image" class="img-fluid">
              </a>
            </div>

            <div class="gallery-item">
              <a href="{{ asset('frontend/assets/img/travel/destination-13.webp') }}" class="glightbox">
                <img src="{{ asset('frontend/assets/img/travel/destination-13.webp') }}" alt="Gallery image" class="img-fluid">
              </a>
            </div>

            <div class="gallery-item">
              <a href="{{ asset('frontend/assets/img/travel/destination-16.webp') }}" class="glightbox">
                <img src="{{ asset('frontend/assets/img/travel/destination-16.webp') }}" alt="Gallery image" class="img-fluid">
              </a>
            </div>

            <div class="gallery-item">
              <a href="{{ asset('frontend/assets/img/travel/destination-18.webp') }}" class="glightbox">
                <img src="{{ asset('frontend/assets/img/travel/destination-18.webp') }}" alt="Gallery image" class="img-fluid">
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="destination-cta">
          <div class="cta-content">
            ...
            <div class="cta-actions">
              <a href="tours.html" class="btn-primary">Explore Tours</a>
              <a href="contact.html" class="btn-outline">Contact Expert</a>
            </div>
          </div>
        </div>
