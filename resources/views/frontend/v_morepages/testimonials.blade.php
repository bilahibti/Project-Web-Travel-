...
<head>
  ...
  <title>Testimonials - TravelTime Bootstrap Template</title>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile">
                  <img src="{{ asset('frontend/img/person/person-m-9.webp') }}" class="testimonial-img" alt="" loading="lazy">
                  <div class="info">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile">
                  <img src="{{ asset('frontend/img/person/person-f-5.webp') }}" class="testimonial-img" alt="" loading="lazy">
                  <div class="info">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile">
                  <img src="{{ asset('frontend/img/person/person-f-12.webp') }}" class="testimonial-img" alt="" loading="lazy">
                  <div class="info">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile">
                  <img src="{{ asset('frontend/img/person/person-m-12.webp') }}" class="testimonial-img" alt="" loading="lazy">
                  <div class="info">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile">
                  <img src="{{ asset('frontend/img/person/person-m-13.webp') }}" class="testimonial-img" alt="" loading="lazy">
                  <div class="info">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile">
                  <img src="{{ asset('frontend/img/person/person-f-13.webp') }}" class="testimonial-img" alt="" loading="lazy">
                  <div class="info">
    ...
    <section id="testimonials" class="testimonials section">
      ...
      <div class="container">
        ...
        <div class="testimonial-masonry">
            ...
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="{{ asset('frontend/img/person/person-f-7.webp') }}" alt="Client">
                </div>
          ...
          <div class="testimonial-item highlight">
            <div class="testimonial-content">
              <div class="quote-pattern">
                <i class="bi bi-quote"></i>
              </div>
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="{{ asset('frontend/img/person/person-m-7.webp') }}" alt="Client">
                </div>
                <div class="client-details">
                  <h3>Daniel Morgan</h3>
          ...
          <div class="testimonial-item">
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="{{ asset('frontend/img/person/person-f-8.webp') }}" alt="Client">
                </div>
                <div class="client-details">
                  <h3>Emma Thompson</h3>
          ...
          <div class="testimonial-item">
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="{{ asset('frontend/img/person/person-m-8.webp') }}" alt="Client">
                </div>
                <div class="client-details">
          ...
          <div class="testimonial-item highlight">
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="{{ asset('frontend/img/person/person-f-9.webp') }}" alt="Client">
                </div>
                <div class="client-details">
                  <h3>Olivia Carter</h3>
          ...
          <div class="testimonial-item">
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="{{ asset('frontend/img/person/person-m-13.webp') }}" alt="Client">
                </div>
                <div class="client-details">
                  <h3>Nathan Brooks</h3>
