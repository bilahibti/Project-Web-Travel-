...
<html
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/vendor/libs/node-waves/node-waves.css') }}" />
  ...
  <body>
    ...
    <div class="position-relative">
      <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner py-6 mx-4">
          ...
          <!-- Register Card -->
          <img
            src="{{ asset('frontend/img/illustrations/tree-3.png') }}"
            alt="auth-tree"
            class="authentication-image-object-left d-none d-lg-block" />
          <img
            src="{{ asset('frontend/img/illustrations/auth-basic-mask-light.png') }}"
            class="authentication-image d-none d-lg-block scaleX-n1-rtl"
            height="172"
            alt="triangle-bg" />
          <img
            src="{{ asset('frontend/img/illustrations/tree.png') }}"
            alt="auth-tree"
    ...
    <script src="{{ asset('frontend/vendor/libs/node-waves/node-waves.js') }}"></script>
