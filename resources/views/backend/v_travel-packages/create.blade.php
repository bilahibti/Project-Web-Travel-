...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row mb-6 gy-6">
            <div class="col-xxl">
                <div class="card">
                    <form class="form-horizontal" action="{{ route('backend.paket.store') }}" method="post" enctype="multipart/form-data">
                        @csrf 
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                <div class="row mt-1 g-5">
                                    <label class="col-sm-2 col-form-label" for="basic-default-destinasi">Destinasi</label>
                                    <div class="col-sm-10">
                            ...
                            <div class="card-body">
                                <div class="row mt-1 g-5">
                                    <label class="col-sm-2 col-form-label" for="basic-default-hotel">Hotel</label>
                                    <div class="col-sm-10">
                            ...
                            <div class="card-body">
                                <div class="row mt-1 g-5">
                                    <label class="col-sm-2 col-form-label" for="basic-default-transportasi">Transportasi</label>
                                    <div class="col-sm-10">
                            ...
                            <div class="row mt-1 g-5">
                                ...
                                <div class="col-sm-10">
                                    <input type="text"  name="durasi" value="{{ old('durasi') }}" class="form-control @error('durasi') is-invalid @enderror" placeholder="Masukkan Durasi"> 
                                    @error('durasi') 
                                    <span class="invalid-feedback alert-danger" role="alert"> 
                                        {{ $message }} 
                                    </span> 
                            ...
                            <div class="row mt-4">
                                <div class="col">
                                    ...
                                    <a href="{{ route('backend.paket.index') }}" class="btn btn-secondary">
                                        Kembali
                                    </a>
                                </div>
                            </div>
